...
@File: label_xyc_to_bbox.py
@Time: 2020-03-05 15:12
@Last_update: 2020-03-05 15:12
@Desc: None
@==============================================@
@      _____             _   _     _   _       @
...
import numpy as np
from yy_lib.process.label_xy_to_bbox import label_xy_to_bbox


def label_xyc_to_bbox(label_array, object_name_list,
    ...
    for c in range(label_array.shape[-1]):
        # 2. 分别得到单通道的bbox
        tmp_bbox_list = label_xy_to_bbox(label_array[...,c], bbox_name_list)
...
if __name__ == '__main__':
    ...
    bbox_list = label_xyc_to_bbox(a, ['lung_l', 'lung_r'])
